...
import { demoData } from "./demo-data.js?v=7";
...
async function handleAction(action){
  try{
    ...
    if(action==="pipeline"){ toast("자동 추정 후보는 만들지 않습니다. 언론사 종합DB와 공식 원문에서 확인된 후보만 유지합니다."); }
