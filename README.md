...
- 한국시간 오전 3시 50분: 전날 00:00~23:59 국가·공공기관 직접 공개 자료만 수집
- Gemini: 최신성 25%, 국민 영향도 30%, 안전성 25%, 검증도 20%로 4~8개 선정
- 정치·정책 자료: 좌우·정당 유불리 해석 없이 확정된 발표·결정·수치만 사용
- 허용 소스: 행정안전부, 한국은행, 금융위원회, 과학기술정보통신부, 문화체육관광부, 보건복지부, 농림축산식품부, 국토교통부, 기상청 공식 RSS
- 파이어베이스에 예약판을 올리고 다음 날 오전 5시부터 웹과 APK에 자동 표시
- GitHub Actions 비밀값: `FIREBASE_ADMIN_EMAIL`, `FIREBASE_ADMIN_PASSWORD`, `GEMINI_API_KEY`
